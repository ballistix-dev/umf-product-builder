<div id="build-your-own-table">

  <ol id="questions"></ol>

  <div id="result">

    <h3>Recommended products based on your <br> selection criteria</h3>
    ...
    <div class="augmented-reality">
      ...
      <div id="UMF/UMFSlider" style="width: 100%; height: 550px;">
        ...
        <bitreel-model-viewer style="width: 100%; height: 100%;" storename="UMF" modelname="FUSION_Blue_Skies" gaid="G-GCELF6MSL9" showmodel="" showexpandbutton="" showqrcode="" model-viewer-camera-orbit="0deg 75deg 140%">
