 ...
 * Register the widget
 */
function REGISTER_UMF_PRODUCT_COMPARE_WIDGET() {
    register_widget( 'UMF_PRODUCT_COMPARE_WIDGET' );
}
add_action( 'widgets_init', 'REGISTER_UMF_PRODUCT_COMPARE_WIDGET' );

/**
 * Class UMF_PRODUCT_COMPARE_WIDGET
 */
class UMF_PRODUCT_COMPARE_WIDGET extends WP_Widget
{
    /** Basic Widget Settings */
    const WIDGET_NAME        = "UMF_PRODUCT_COMPARE";
    const WIDGET_DESCRIPTION = "UMF_PRODUCT_COMPARE";
    public $textdomain;
    public $fields;
    /**
    ...
    private function widget_output($args, $instance)
    {
        ...
        include sprintf("%s/../template/compare.php", dirname(__FILE__));
    ...
    public function plugin_enqueue()
    {
      ...
      wp_enqueue_style(
        ...
        wp_enqueue_script(
            'UMF_PRODUCT_COMPARE_BUILD',
            plugins_url('js/compare.js', dirname(__FILE__)),
            array('jquery'),
            UMF_PRODUCT_DATA_VERSION,
            true
        );
